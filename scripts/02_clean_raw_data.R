...
writexl::write_xlsx(
  x = list("question" = important_characteristics__coder_vs_non_coder1,
           "total_responses" = totals_per_how_important),
  path = paste0("dataperquestion/",
                Sys.Date(), "_", "how_important_are",
                ".xlsx"),
  format_headers = FALSE)
